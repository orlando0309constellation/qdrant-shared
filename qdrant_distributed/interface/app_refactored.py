...
class QdrantManagerApp:
    ...
    def _on_operation_start(self):
        ...
        self.output_panel.progress_bar.show()
    ...
    def _on_operation_complete(self):
        ...
        self.output_panel.progress_bar.hide()
        self.output_panel.progress_bar.update(0)
    
    def _on_progress_update(self, value: float):
        """Handle progress update event."""
        self.output_panel.progress_bar.update(value)
